...
public class BatchletArtifact {
    ...
    public BatchletArtifact(Object artifact) {
        this.artifact = artifact;
        processMethod = findAnnotatedMethod(artifact.getClass(), Process.class, new Predicate<Method>() {
            @Override
        ...
        stopMethod = findAnnotatedMethod(artifact.getClass(), Stop.class, new Predicate<Method>() {
            @Override
            public boolean apply(Method m) {
    ...
    public String process() throws Exception {
        ...
        try {
            exitStatus = (String) processMethod.invoke(artifact);
