 ...
 */
public class JabatSubsystemParsingTestCase extends AbstractSubsystemTest {

    public JabatSubsystemParsingTestCase() {
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + JabatSubsystemExtension.NAMESPACE + "\">"
                + "</subsystem>";
        ...
        Assert.assertEquals(JabatSubsystemExtension.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(JabatSubsystemExtension.SUBSYSTEM_NAME));
    }
    ...
    public void testDescribeHandler() throws Exception {
        ...
        describeOp.get(OP_ADDR).set(
                ...
                PathElement.pathElement(SUBSYSTEM, JabatSubsystemExtension.SUBSYSTEM_NAME)).toModelNode());
