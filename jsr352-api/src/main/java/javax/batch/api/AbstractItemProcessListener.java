...
/**
 * The AbstractItemProcessListener provides default implementations of optional
 * methods.
 *
 * @param <T> specifies the item type read by the ItemProcessor paired with this
 * ItemProcessListener.
 *
 * @param <R> specifies the item type returned by the ItemProcessor paired with
...
public abstract class AbstractItemProcessListener<T, R> implements
     ...
     * Optional method.
     *
     * Implement this method if the ItemProcessListener will do something before
     ...
     * Optional method.
     *
     * Implement this method if the ItemProcessListener will do something after
     * the item is processed. The default implementation does nothing.
     *
     * @param item specifies the item about to be processed.
     ...
     * Optional method.
     *
     * Implement this method if the ItemProcessListener will do something when
