...
public interface ItemWriteListener<T> {
     ...
     */
    void beforeWrite(List<T> items) throws Exception;
     ...
     * @throws Exception is thrown if an error occurs.
     */
    void afterWrite(List<T> items) throws Exception;
     ...
     * @throws Exception is thrown if an error occurs.
     */
    void onWriteError(List<T> items, Exception ex) throws Exception;
}
