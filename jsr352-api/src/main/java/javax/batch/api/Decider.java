 ...
 * transition.
 *
* @param <T> specifies the type of the transient data in the batch context.
 */
public interface Decider<T> {
     ...
     *
     * @param ctx specifies the last execution element's batch context. It may
     * be a StepContext, FlowContext, or SplitContext.
     * @return updated job exit status
     * @throws Exception is thrown if an error occurs.
     */
    String decide(BatchContext<T> ctx) throws Exception;
}
