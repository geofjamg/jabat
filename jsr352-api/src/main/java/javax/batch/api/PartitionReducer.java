...
public interface PartitionReducer {
     ...
     * control if any of the following conditions are true: <p> <ol> <li>One or
     * more partitions end with a Batch Status of STOPPED or FAILED.</li>
     * <li>Any of the following partitioned step callbacks throw an
     * exception:</li> <ol> <li>PartitionMapper</li> <li>PartitionReducer</li>
     * <li>PartitionCollector</li> <li>PartitionAnalyzer</li> </ol> <li>A job
     * with partitioned steps is restarted.</li> </ol>
     *
     * @throws Exception is thrown if an error occurs.
     */
